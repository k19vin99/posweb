          ...
          <div style={{ width: '100%', maxWidth: '700px', marginLeft: '0px' }}>
            ...
            <div style={formStyle.container}>
              ...
              <form onSubmit={handleSubmit} style={formStyle.form}>
                ...
                <h2 style={formStyle.subtitle}>Empresa a la que pertenece el usuario</h2>
                ...
                <h2 style={formStyle.subtitle}>Almácen al que pertenece el usuario</h2>
                <select
                  name="store_id"
                  value={user.store_id}
                ...
                <h2 style={formStyle.subtitle}>Correo Eléctronico</h2>
